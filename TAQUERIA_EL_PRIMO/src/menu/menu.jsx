  ...
  return (
    <div className="w-full min-h-screen flex">
              ...
              return (
                ...
                >
                  ...
                  <img
                    ...
                    alt={val.title}
                  ></img>
                  <button type="button" onClick={openModal} className="p-2">
                    <HiPlus
                      size="26px"
                      color="#FFF"
      ...
      <div className="w-2/6 pt-7 pr-7 pb-7 fixed end-3 h-screen">
        <div className="bg-slate-100 h-full rounded-xl dashed-border">
          <h1 className="text-center font-bold text-2xl">Orden</h1>
          <Orden />
        </div>
      </div>
    </div>
